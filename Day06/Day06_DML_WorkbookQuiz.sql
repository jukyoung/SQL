...
create table tb_학생일반정보 as select student_no "학번", student_name "학생이름",
 student_address "학생 주소" from tb_student;
...
select point, term_no, class_name, department_name, student_name 
 from tb_student join tb_department using(department_no)
  ...
  join tb_class using(department_no) where student_name = '김명훈' 
